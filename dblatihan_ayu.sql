...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=449544550ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:8082 / localhost | phpMyAdmin 5.1.3</title>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dblatihan_ayu&table=peserta">`dblatihan_ayu`.`peserta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokobuku_ayuarmadani&table=tabel_promosi_ayuarmadani">`tokobuku_ayuarmadani`.`tabel_promosi_ayuarmadani`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokobuku_ayuarmadani&table=tabel_buku_ayuarmadani">`tokobuku_ayuarmadani`.`tabel_buku_ayuarmadani`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Ujian_Online_AyuArmadaniPutriMahirun&table=Tbl_Soal_Ujian_AyuArmadaniPutriMahirun">`Ujian_Online_AyuArmadaniPutriMahirun`.`Tbl_Soal_Ujian_AyuArmadaniPutriMahirun`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uas_ayu&table=tb_barang">`uas_ayu`.`tb_barang`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6143253b71415b5377767c417a41507d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="uas_ayu" targettable="tb_barang">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_barang`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_buku_ayuarmadani">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Query failed
                            ...
                            <span class="text targetdb">
            Database
                            : <span>tokobuku_ayuarmadani</span>
                    </span>
                            <span class="text query_time">
            Queried time
                            : <span>During current session</span>
                            ...
                            <span class="query">CREATE TABLE `tokobuku_ayuarmadani`.`tabel_buku_ayuarmadani` ( `id_buku` CHAR(15) NOT NULL ,  `judul_buku` VARCHAR(200) NOT NULL ,  `penulis` VARCHAR(200) NOT NULL ,  `deskripsi` TEXT NOT NULL ,  `harga` DOUBLE NOT NULL ,  `gambar` TEXT NOT NULL ,    PRIMARY KEY  (`id_buku`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_promosi_ayuarmadani">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `tokobuku_ayuarmadani`.`tabel_promosi_ayuarmadani` ( `id_promosi` CHAR(20) NOT NULL ,  `id_buku` CHAR(15) NOT NULL ,    PRIMARY KEY  (`id_promosi`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_buku_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tabel_buku_ayuarmadani`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_buku_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `tabel_buku_ayuarmadani` (`id_buku`, `judul_buku`, `penulis`, `deskripsi`, `harga`, `gambar`) VALUES (&#039;B001&#039;, &#039;Madame Badobedah&#039;, &#039;Sophie Dahl&#039;, &#039;A timeless story celebrating friendship and imagination, from an exciting new voice in children\&#039;s literature.&#039;, &#039;172963&#039;, &#039;https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1551431156l/44164977._SX318_.jpg&#039;), (&#039;B002&#039;, &#039;Maria\&#039;s Island&#039;, &#039;Victoria Hislop&#039;, &#039;The absorbing story of the Cretan village of Plaka and the tiny, deserted island of Spinalonga - Greece\&#039;s former leper colony - is told us by Maria Petrakis, one of the children in the original version of The Island.&#039;, &#039;172250&#039;, &#039;https://imusic.b-cdn.net/images/item/original/118/9781529504118.jpg?victoria-hislop-2022-maria-s-island-paperback-book&amp;class=scaled&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_buku_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tabel_promosi_ayuarmadani`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_promosi_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `tabel_promosi_ayuarmadani` (`id_promosi`, `id_buku`) VALUES (&#039;B001&#039;, &#039;B001&#039;), (&#039;B002&#039;, &#039;B002&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_promosi_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `gambar` FROM `tabel_buku_ayuarmadani` WHERE `tabel_buku_ayuarmadani`.`id_buku` = &#039;B001&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_buku_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tabel_buku_ayuarmadani`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="Ujian_Online_AyuArmadaniPutriMahirun" targettable="Tbl_Soal_Ujian_AyuArmadaniPutriMahirun">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Query failed
                            ...
                            <span class="text targetdb">
            Database
                            : <span>Ujian_Online_AyuArmadaniPutriMahirun</span>
                    </span>
                            <span class="text query_time">
            Queried time
                            : <span>During current session</span>
                            ...
                            <span class="query">SELECT * FROM `Tbl_Soal_Ujian_AyuArmadaniPutriMahirun`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="tokobuku_ayuarmadani" targettable="tabel_buku_ayuarmadani">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tabel_promosi_ayuarmadani`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="dblatihan_ayu" targettable="peserta">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `peserta`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dblatihan_ayu" targettable="peserta">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `peserta` (`id`, `nama`, `jender`, `tanggal_lahir`, `email`, `alamat`, `no_hp`, `jenis_kursus`, `jadwal`) VALUES (&#039;1&#039;, &#039;Ayu Armadani&#039;, &#039;Perempuan&#039;, &#039;2022-08-01&#039;, &#039;ayu@lenna.ai&#039;, &#039;jl&#039;, &#039;0237298463&#039;, &#039;Matematika&#039;, &#039;siang&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dblatihan_ayu" targettable="peserta">
                            <div class="action_content">
